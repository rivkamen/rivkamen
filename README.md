...
#### 🧰 Development Tools:
- Visual Studio, VS Code, Eclipse, PyCharm, Jupyter
- Git & GitHub
...
### 🚀 Currently Learning:
- Advanced React and Redux Toolkit  
- Server-side security and CI/CD best practices  
- Real-time web systems using sockets & APIs
